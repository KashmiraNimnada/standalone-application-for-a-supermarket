...
public class CrudUtil {
    ...
    private static PreparedStatement setStatement(String sql,Object... args) throws ClassNotFoundException, SQLException{
    ...
    public static boolean executeUpdate(String sql,Object... args) throws Exception{
        PreparedStatement statement = setStatement(sql,args);
        return statement.executeUpdate()>0;
    }
    
    public static ResultSet executeQuery(String sql,Object... args) throws Exception{
        return setStatement(sql,args).executeQuery();
    }
